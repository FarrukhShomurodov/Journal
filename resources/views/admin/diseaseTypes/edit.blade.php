...
@section('title')
    <title>Journal - Редактировать тип заболеваний</title>
@endsection

@section('content')
    <h6 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light"><a class="text-muted"
                                             href="{{ route('diseaseTypes.index') }}">Типы заболеваний</a> /</span>Редактировать
    </h6>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('diseaseTypes.update', $diseaseType->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    ...
                    <input type="text" name="name[ru]" class="form-control @error('name.ru') is-invalid @enderror"
                           ...
                           id="name_ru" value="{{ $diseaseType->name['ru'] }}" required>
                    @error('name.ru')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name[en]" class="form-control @error('name.en') is-invalid @enderror"
                           ...
                           id="name_en" value="{{ $diseaseType->name['en'] }}" required>
                    @error('name.en')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name[uz]" class="form-control @error('name.uz') is-invalid @enderror"
                           ...
                           id="name_uz" value="{{ $diseaseType->name['uz'] }}" required>
                    @error('name.uz')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name[kz]" class="form-control @error('name.kz') is-invalid @enderror"
                           ...
                           id="name_kz" value="{{ $diseaseType->name['kz'] }}" required>
                    @error('name.kz')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name[tj]" class="form-control @error('name.tj') is-invalid @enderror"
                           ...
                           id="name_tj" value="{{ $diseaseType->name['tj'] }}" required>
                    @error('name.tj')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
