...
@section('title')
    <title>{{ 'Findz - ' . __('usefulInfo.create_usefulInfo') }}</title>
@endsection

@section('content')
    <h6 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light"><a class="text-muted" href="{{ route('usefulInfos.index') }}">{{ __('usefulInfo.usefulInfos') }}</a> /</span>@lang('commands.create')
    </h6>
    @if ($errors->any())
            ...
            <form action="{{ route('usefulInfos.store') }}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" name="description[ru]"
                              ...
                              placeholder="@lang('usefulInfo.description')" required></textarea>
                ...
                <div class="mb-3">
                    <label for="imageInput" class="form-label">{{ __('promotion.upload_images') }}</label>
