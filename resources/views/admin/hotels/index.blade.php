...
@section('title')
    <title>{{ 'Findz - ' . __('hotel.hotels') }}</title>
@endsection

@section('content')
    <h6 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">@lang('hotel.hotels')</span>
    </h6>
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-header">@lang('hotel.hotels')</h5>
        ...
        <div class="card-datatable table-responsive">
            <table class="datatables-users table border-top">
                ...
                @foreach ($hotels as $hotel)
                    <tr>
                        <td>
                            @foreach($hotel->name as $lang => $name)
                        ...
                        <td>
                            <div class="d-inline-block text-nowrap">
                                <button class="btn btn-sm btn-icon"
                                        onclick="location.href='{{ route('hotels.edit', $hotel->id) }}'"><i
