            ...
            <form action="{{ route('entertainments.update', $entertainment->id) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="working_hours"
                           ...
                           value="{{ $entertainment->working_hours }}" required>
                    @error('working_hours')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="price_from"
                           ...
                           placeholder="Цена от"
                           value="{{ $entertainment->price_from ? round($entertainment->price_from) : null }}">
                    @error('price_from')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="price_to"
                           ...
                           placeholder="Цена до"
                           value="{{ $entertainment->price_to ? round($entertainment->price_to) : null }}">
                    @error('price_to')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="contacts[type_value][{{ $index }}]"
                                               ...
                                               value="{{ $entertainment->contacts['type_value'][$index] }}" required>
